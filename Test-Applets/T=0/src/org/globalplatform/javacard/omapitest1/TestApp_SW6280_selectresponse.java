...
public class TestApp_SW6280_selectresponse extends Applet {
	private boolean mIsExpectingGetResponse = false;

    public static void install(byte[] aArray, short sOffset, byte bLength) {
        new TestApp_SW6280_selectresponse(aArray, sOffset, bLength);
    }

    private TestApp_SW6280_selectresponse(byte[] aArray, short sOffset,
            byte bLength) {
