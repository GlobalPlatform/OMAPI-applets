...
public class TestApp_SW6283_selectresponse_etsi extends TestApp_SWwarn_selectresponse_etsi
{
    public static void install(byte[] aArray, short sOffset, byte bLength)
    {
        new TestApp_SW6283_selectresponse_etsi(aArray, sOffset, bLength);
    }

    private TestApp_SW6283_selectresponse_etsi(byte[] aArray, short sOffset, byte bLength)
    {
	super((short)0x6283);
