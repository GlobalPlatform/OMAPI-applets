...
public class TestApp_SW6280_partial extends Applet {

    public static void install(byte[] aArray, short sOffset, byte bLength) {
        new TestApp_SW6280_partial(aArray, sOffset, bLength);
    }

    private TestApp_SW6280_partial(byte[] aArray, short sOffset, byte bLength) {
