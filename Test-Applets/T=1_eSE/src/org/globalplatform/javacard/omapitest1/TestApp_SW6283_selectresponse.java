...
public class TestApp_SW6283_selectresponse extends Applet {

    public static void install(byte[] aArray, short sOffset, byte bLength) {
        new TestApp_SW6283_selectresponse(aArray, sOffset, bLength);
    }

    private TestApp_SW6283_selectresponse(byte[] aArray, short sOffset,
            byte bLength) {
