...
public class TestApp_SW63C1_selectresponse extends Applet {

    public static void install(byte[] aArray, short sOffset, byte bLength) {
        new TestApp_SW63C1_selectresponse(aArray, sOffset, bLength);
    }

    private TestApp_SW63C1_selectresponse(byte[] aArray, short sOffset,
            byte bLength) {
